    ...
    <div class="row">
        ...
        @if( Auth::user() !== null )
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <a class="dropdown-item" href="#"><button id='contacto' type='button' onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Desconectar</button></a>
                <a class="dropdown-item" href="#"><button id='perfil' type='button' onclick="event.preventDefault(); document.getElementById('perfil-form').submit();">Perfil</button></a>
